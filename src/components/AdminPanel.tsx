              ...
              >
                ...
                <div className="space-y-6">
                  <div className="flex justify-between items-end">
                    <div>
                      <div className="text-[9px] text-slate-550 uppercase font-black">Efectivo Solicitado</div>
                  ...
                  <div className="bg-black/20 rounded-xl p-4 border border-slate-800/50 space-y-3">
                    <div>
                      <div className="text-[9px] text-slate-500 uppercase font-black mb-1">Cliente</div>
                      <div className="text-[12px] font-black text-slate-100">
                        {credit.clientName || (() => {
                          const c = allClients.find(cl => cl.id === credit.clientId || cl.dni === credit.clientId);
                          return c ? `${c.firstName} ${c.lastName}` : 'No registrado';
                        })()}
                      </div>
                      <div className="text-[9px] font-mono text-slate-500 mt-0.5">DNI: {credit.clientDni || credit.clientId}</div>
                    </div>

                    <div className="grid grid-cols-2 gap-2 pt-2.5 border-t border-slate-800/60">
                      <div>
                        <div className="text-[9px] text-slate-500 uppercase font-black">Deuda Total</div>
                        <div className="text-xs font-black text-slate-200">
                          {credit.simulationDetails?.totalToPay ? formatCurrency(credit.simulationDetails.totalToPay) : 'No calculado'}
                        </div>
                      </div>
                      <div>
                        <div className="text-[9px] text-slate-500 uppercase font-black">Plazo</div>
                        <div className="text-xs font-black text-slate-200">
                          {credit.simulationDetails?.months ? `${credit.simulationDetails.months} meses` : 'No calculado'}
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-2 pt-2.5 border-t border-slate-800/60">
                      <div>
                        <div className="text-[9px] text-slate-500 uppercase font-black">Monto Mensual</div>
                        <div className="text-xs font-black text-emerald-400">
                          {credit.simulationDetails?.monthlyFee ? formatCurrency(credit.simulationDetails.monthlyFee) : 'No calculado'}
                        </div>
                      </div>
                      <div>
                        <div className="text-[9px] text-slate-500 uppercase font-black">Promotor</div>
