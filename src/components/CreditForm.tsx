  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const creditData = {
        ...
        clientDni: client.dni || client.id,
        simulationDetails: {
      ...
      adminsSnapshot.docs.forEach(adminDoc => {
        ...
        batch.set(notificationRef, {
          ...
          message: `Detalle de la solicitud para ${client.firstName} ${client.lastName} (DNI: ${client.dni || client.id}):\n• Monto a otorgar: ${formatCurrency(selectedAmount)}\n• Monto total de deuda: ${formatCurrency(totalCharge)}\n• Monto mensual: ${formatCurrency(finalMonthlyFee)}\n• Duración: ${displayMonths} meses.`,
          type: 'warning',
          read: false,
          createdAt: serverTimestamp()
        });
